...
const BorderGlow = ({
  ...
  const handleScroll = useCallback(() => {
    ...
    // Use scroll y position or window center relative to the card to simulate movement
    const x = window.innerWidth / 2 - rect.left;
    // Tie the y coordinate to the window scroll offset rather than mouse move
  ...
  useEffect(() => {
    // Only update on scroll (scene change) instead of real-time mouse movement
